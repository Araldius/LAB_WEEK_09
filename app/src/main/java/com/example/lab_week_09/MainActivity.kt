...
fun Home() {
    ...
    val listData = remember {
        mutableStateListOf(
            ...
            Student("Tina"),
            Student("Tono")
        ) // Penutup kurung dipindahkan agar sesuai sintaks Kotlin
    } // Penutup kurung dipindahkan agar sesuai sintaks Kotlin
    ...
    //Here, we pass:
    //ListData to show the List of items inside HomeContent inputField to show the input field value inside HomeContent
    //A Lambda function to update the value of the inputField
    //A Lambda function to add the inputField to the ListData
    HomeContent(
        listData,
        inputField.value,
        { input -> inputField.value = inputField.value.copy(name = input) }, // 'name =' ditambahkan untuk sintaks copy data class
        {
            if (inputField.value.name.isNotBlank()) {
                listData.add(inputField.value) // Dipindahkan ke dalam 'if'
            }
        ...
        item {
            Column(
                ...
                TextField(
                    ...
                    onValueChange = {
                        //Here, we call the onInputValueChange Lambda function and pass the value of the input field as a parameter
                ...
                Button(onClick = {
                    ...
                    //This is so that we can add the inputField value to the ListData and reset the value of the inputField
                    onButtonClick()
                }) {
