...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            //You can check out the LAB_WEEK_09 Theme inside Theme.kt
            LAB_WEEK_09Theme {
                Surface(
                    //We use Modifier.fillMaxSize() to make the surface fill the whole screen
                    modifier = Modifier.fillMaxSize(),
                    //We use Material Theme.colorScheme.background to get the background color and set it as the color of the surface
...
//Notice that we remove the @Preview annotation this is because we're passing a parameter into the composable
//When the compiler tries to build the preview, it doesn't know what to pass into the composable
//So, we create another composable function called PreviewHome and we pass the List as a parameter
@Composable
fun Home(
    ...
    //LazyColumn is more efficient than Column because it only composes and Lays out the currently visible items much like a RecyclerView
    ...
    LazyColumn {
        ...
        item {
            Column(
                ...
                //You can also use Modifier.padding(horizontal = 16.dp, vertical = 8.dp) to add padding horizontally and vertically or Modifier.padding(start = 16.dp, top = 8.dp, end = 16.dp, bottom = 8.dp to add padding to each side
                ...
                TextField(
                    ...
                    keyboardOptions = KeyboardOptions(
                        keyboardType = KeyboardType.Number // Di PDF KeyboardType.Number, namun di Part 2 jadi KeyboardType.Text. Saya gunakan .Number sesuai langkah ini.
                    ),
